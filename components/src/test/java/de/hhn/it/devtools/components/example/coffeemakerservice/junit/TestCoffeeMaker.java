...
public class TestCoffeeMaker {
  ...
  @BeforeEach
  void setup() {
    maker = new WnckCoffeeMaker(new CoffeeMakerConfiguration("A106", "Senseo muddy brown"));
  }
  ...
  /**
   * Inner class as a CoffeeMakerListener. Allows to check how often the callback has been called
   * and which values were passed.
   */
  class SimpleCoffeeMakerListener implements CoffeeMakerListener {

    public List<State> states;
    public List<Integer> cupCounters;

    public SimpleCoffeeMakerListener() {
      states = new ArrayList<>();
      cupCounters = new ArrayList<>();
    }
    ...
    public List<Integer> getCupCounters() {
      return cupCounters;
    }
  }
}
