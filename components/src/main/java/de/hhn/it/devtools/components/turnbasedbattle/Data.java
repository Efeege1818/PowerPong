...
public class Data {
  ...
  private Monster[] createMonsters() {
    return new Monster[] {
      new Monster(18, 10, 3, 0.1, 0.1, Element.FIRE, getFireMonsterMoves()),
      new Monster(20, 8, 8, 0.2, 0.2, Element.GRASS, getGrassMonsterMoves()),
      new Monster(15, 6, 6, 0.1, 0.1, Element.WATER, getWaterMonsterMoves()),
    };
  }
