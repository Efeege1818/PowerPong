...
public interface CoffeeMakerService {
   ...
   */
  List<CoffeeMakerConfiguration> getCoffeeMakers();
   ...
   */
  CoffeeMakerConfiguration getCoffeeMaker(int id) throws IllegalParameterException;
  ...
  /**
   * Returns the actual State of the maker.
   *
   * @param id id of the machine
   * @return actual state of the maker
   * @throws IllegalParameterException if the maker does not exist
   * @throws IllegalStateException     if the maker cannot start cleaning now
   */
  State getState(int id)  throws IllegalParameterException, IllegalStateException;
}
