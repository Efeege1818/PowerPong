 ...
 */
public record BuffMove(MoveType type, String name, Element element, String stat, double amount, int duration, int cooldown, boolean isSpecial, String description) implements Move {
   ...
   */
  public BuffMove(String name, Element element, String stat, double amount, int duration, int cooldown, boolean isSpecial, String description) {
    this(MoveType.BUFF, name, element, stat, amount, duration, cooldown, isSpecial, description);
  }
